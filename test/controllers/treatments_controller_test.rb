...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { discount: @treatment.discount, done: @treatment.done, pacient_id: @treatment.pacient_id, procedure_id: @treatment.procedure_id }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { discount: @treatment.discount, done: @treatment.done, pacient_id: @treatment.pacient_id, procedure_id: @treatment.procedure_id }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
