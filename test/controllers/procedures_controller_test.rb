...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { description: @procedure.description, followup: @procedure.followup, insurance_id: @procedure.insurance_id, name: @procedure.name, proceduretype_id: @procedure.proceduretype_id, value: @procedure.value }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { description: @procedure.description, followup: @procedure.followup, insurance_id: @procedure.insurance_id, name: @procedure.name, proceduretype_id: @procedure.proceduretype_id, value: @procedure.value }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
